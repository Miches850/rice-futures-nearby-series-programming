...
/*                                                                       */
/* This file preserves the submitted analytical logic while changing:    */
/*   - personal machine paths to repository-relative paths               */
/*   - the student identifier to [redacted]                              */
/*                                                                       */
/* IMPORTANT: The original raw 20 contract CSV files were not retained   */
/* in the supplied artifact set. This script therefore cannot run        */
/* end-to-end until those files are restored.                            */
/*                                                                       */
/* See docs/REPRODUCIBILITY_NOTES.md before treating the submitted        */
/* Nearby construction logic as a validated implementation of the        */
/* assignment's rollover definition.                                    */
/* ===================================================================== */

options dlcreatedir;
libname _gitout "./outputs";
